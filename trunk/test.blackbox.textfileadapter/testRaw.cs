...
namespace test.blackbox.textfileadapter
{
    ...
    public class testRaw
    {
        ...
        {
            IFileAdapter fa = new dnppv.textfileadapter.RawTextFileAdapter();
            fa.Open("test1.txt");
            fa.Close();
            try
            {
            ...
            using (fa = new dnppv.textfileadapter.RawTextFileAdapter())
            {
                fa.Open("test1.txt");
            }
        ...
        {
            using (IFileAdapter fa = new dnppv.textfileadapter.RawTextFileAdapter())
            {
                fa.Open("test1.txt");
